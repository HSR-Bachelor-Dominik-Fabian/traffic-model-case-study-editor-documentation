...
\newglossaryentry{LIKE}{name=SQL LIKE Operator,description={Der SQL LIKE Operator wird für das Suchen eines spezifischen Patterns in einer Spalte verwendet 
